    ...
    <header className="p-3 text-white mb-3 border-bottom">
      {!isAuth() && (
        <div className="container">
          <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <Link to='/' className="h2 d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none">daily tasks</Link>
      ...
      {isAuth() && (
        <div className="container-fluid">
          <div className="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            <Link to='/dashboard' className="h2 d-flex align-items-center mb-2 mb-lg-0 text-dark text-decoration-none me-2">daily tasks</Link>
